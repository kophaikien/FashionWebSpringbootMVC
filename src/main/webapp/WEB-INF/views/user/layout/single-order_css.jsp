...
<link rel="stylesheet" type="text/css" href="${path}/user/styles/categories_responsive.css">
<link rel="stylesheet" type="text/css" href="${path}/user/styles/bootstrap.min.css">

<link rel="stylesheet" type="text/css" href="${path}/user/styles/single-order_styles.css">

																	...
																	<c:forEach var="cartProduct" items="${cart.cartProducts }"
																		...
																		<tr>
																			...
																			<td><img width="60px" height="60px"
																				src="${path}/UploadFiles/${cartProduct.avatar }"
																				class="light-logo"></td>
																			...
																			<td align="center"><a
																				href="${path }/product/${cartProduct.id }"
																				role="button" class="btn btn-secondary">Edit</a> 
																				<a onclick ="return confirm('Are you sure?')"
																				href="${path }/delete/${cartProduct.id }"
							...
							<div class="page-breadcrumb">
								...
								<div class="row">
									<div class="main__products-title">
										<p style="margin-left:10px;">Thông tin khách hàng</p>
									</div>
								</div>
								<%-- form action="${path }/cart-view" method="get">--%>
									<div class="row">
											...
											<div class="card">
												<div class="card-body">
													...
													<!--  	<form action="/place-order" method="POST">
														    ...
														    <input type="radio" id="onlinePayment" name="paymentMethod" value="ONLINE" checked> Thanh toán trực tuyến<br>
														    <input type="radio" id="cod" name="paymentMethod" value="COD"> Thanh toán khi nhận hàng<br>
														    <button type="submit">Đặt hàng</button>
														</form>
														-->
														<div class="row" p-t-30 >
															<div class="col-md-12">
																<div class="form-group mb-4" style="display: inline-block">
																	<a href="${path }/index"

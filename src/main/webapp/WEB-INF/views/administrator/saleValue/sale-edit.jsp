          ...
          <div class="row align-items-center">
            <div class="col-md-12">
              <div class="page-header-title">
                <h5 class="m-b-10">Chỉnh sửa giảm giá</h5>
              </div>
            </div>
          </div>
        </div>
                ...
                <!-- basic table -->
               	<div class="row">
                	<div class="col-12">
	                    <div class="card">
	                        <div class="card-body">
	                        	<sf:form class="form" action="${path }/admin/saleValue/edit-save" method="post" modelAttribute="saleValue" enctype="multipart/form-data">
	                        		 <div class="form-body">
	                        			...
	                        			<div class="row">
	                        		 		...
	                        		 		<div class="col-md-6">
												<div class="form-group mb-4">
			                                        ...
			                                        <sf:input path="name" type="text" class="form-control" id="name" name="name" placeholder="Sale value name"></sf:input>
                                        		</div>
	                                    	</div>
	                                    	<div class="col-md-6">
												<div class="form-group mb-4">
